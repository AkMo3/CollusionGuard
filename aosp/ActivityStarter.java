...
class ActivityStarter {
    ...
    int execute() {
        try {
            ...
            String logString = "ActivityStarter: ";
            if (mRequest.callingPackage != null) logString = logString + ", Sender: " + mRequest.callingPackage;
            // if (mRequest.resultWho != null) logString = logString + ", resultWho: " + mRequest.resultWho;
            if (mRequest.intent !=  null && mRequest.intent.getComponent() != null) {
                Intent mIntent = mRequest.intent;
                String componentName = mIntent.getComponent().getPackageName();
                logString = logString + ", Receiver: " + componentName;
                String dataPassed = "";
                ...
                logString = logString + ", Data: " + dataPassed;
                PermissionMonitor permissionMonitor = PermissionMonitor.getInstance();
                if (mRequest.callingPackage != null && dataPassed != "") {
                    permissionMonitor.validateTransaction(dataPassed, mRequest.callingPackage, componentName);
                }
